...
class SearchScreen extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (
      ...
      newState = {
        ...newState,
        successSearchbyCategoryVersion:
          nextProps.successSearchbyCategoryVersion,
      };
    }
  ...
  async componentDidUpdate(prevProps, prevState) {
    ...
    if (
      this.state.errorAllParamaterVersion > prevState.errorAllParamaterVersion
    ) {
    }
  }
  ...
  karatModal = () => {
    this.setState({
      isKaratModalVisible: !this.state.isKaratModalVisible,
      isOkKaratClicked: false,
    });
  };
